    ...
    return (
         <div className="col-md-3 col-lg-2 sidebar-offcanvas pl-10" id="sidebar" role="navigation" style={{backgroundColor:"#e9ecef"}}>
            <ul className="nav flex-column sticky-top pl-0 pt-5 p-3 mt-3 ">
                ...
                <li className="nav-item mb-2"><a className="nav-link text-secondary" href="/ownerlist"><i className="fas fa-tablet-alt font-weight-bold"></i><span className="ml-3">Owner</span></a></li>
